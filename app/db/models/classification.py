...
#
#     # ---------- EMBEDDINGS ----------
#     content_embedding: Optional[List[float]] = Field(sa_column=Column(Vector(1536)))
#
#     # ---------- RELATIONSHIPS ----------
...
#
#     future_queue_items: List["FutureContentQueue"] = Relationship(back_populates="atom")
#
#     content_lineages: List["ContentLineage"] = Relationship(back_populates="atom")
